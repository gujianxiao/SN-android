...
public final class RibEntryProto {
  ...
  public interface RibEntryMessageOrBuilder
     ...
     * </pre>
     */
    java.util.List<RibEntryMessage.RibEntry>
        getRibEntryList();
    /**
     * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
     *
     ...
     * </pre>
     */
    RibEntryMessage.RibEntry getRibEntry(int index);
    /**
     * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    java.util.List<? extends RibEntryMessage.RibEntryOrBuilder>
     ...
     * </pre>
     */
    RibEntryMessage.RibEntryOrBuilder getRibEntryOrBuilder(
            int index);
  }
  /**
  ...
  public static final class RibEntryMessage extends
          ...
          switch (tag) {
            ...
            case 1026: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                ribEntry_ = new java.util.ArrayList<RibEntry>();
                mutable_bitField0_ |= 0x00000001;
              }
              ribEntry_.add(input.readMessage(RibEntry.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RibEntryMessage.class, Builder.class);
    }
    ...
    public static final class Name extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_Name_descriptor;
      }

      protected FieldAccessorTable
          internalGetFieldAccessorTable() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_Name_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
  ...
  ensureComponentIsMutable();
    ...
    public static final class Route extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_Route_descriptor;
      }

      protected FieldAccessorTable
          internalGetFieldAccessorTable() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_Route_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
    ...
    public static final class RibEntry extends
            ...
            switch (tag) {
              ...
              case 1034: {
                if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                  routes_ = new java.util.ArrayList<Route>();
                  mutable_bitField0_ |= 0x00000002;
                }
                routes_.add(input.readMessage(Route.PARSER, extensionRegistry));
                break;
              }
            }
          }
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_RibEntry_descriptor;
      }

      protected FieldAccessorTable
          internalGetFieldAccessorTable() {
        return RibEntryProto.internal_static_net_named_data_jndn_tests_RibEntryMessage_RibEntry_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                RibEntry.class, Builder.class);
      }
      ...
      public static RibEntry parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static RibEntry parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static RibEntry parseFrom(
      ...
      public static RibEntry parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseFrom(input);
      }
      public static RibEntry parseFrom(
      ...
      public static RibEntry parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static RibEntry parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input, extensionRegistry);
      ...
      public static Builder newBuilder() { return Builder.create(); }
      public Builder newBuilderForType() { return newBuilder(); }
      public static Builder newBuilder(RibEntry prototype) {
        return newBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() { return newBuilder(this); }
      ...
      public static final class Builder extends
        ...
        public RibEntry getDefaultInstanceForType() {
          return RibEntry.getDefaultInstance();
        }

        public RibEntry build() {
          RibEntry result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public RibEntry buildPartial() {
          RibEntry result = new RibEntry(this);
          int from_bitField0_ = bitField0_;
          int to_bitField0_ = 0;
          if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
            to_bitField0_ |= 0x00000001;
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof RibEntry) {
            return mergeFrom((RibEntry)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(RibEntry other) {
          if (other == RibEntry.getDefaultInstance()) return this;
          if (other.hasName()) {
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          RibEntry parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (RibEntry) e.getUnfinishedMessage();
            throw e;
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
    ...
    private java.util.List<RibEntry> ribEntry_;
    /**
     * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public java.util.List<RibEntry> getRibEntryList() {
      return ribEntry_;
    }
    /**
     * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
     ...
     * </pre>
     */
    public java.util.List<? extends RibEntryOrBuilder>
        getRibEntryOrBuilderList() {
      return ribEntry_;
    }
    /**
     ...
     * </pre>
     */
    public RibEntry getRibEntry(int index) {
     ...
     * </pre>
     */
    public RibEntryOrBuilder getRibEntryOrBuilder(
        int index) {
      return ribEntry_.get(index);
    }
    ...
    public static RibEntryMessage parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static RibEntryMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RibEntryMessage parseFrom(
    ...
    public static RibEntryMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static RibEntryMessage parseFrom(
    ...
    public static RibEntryMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static RibEntryMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(RibEntryMessage prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public RibEntryMessage getDefaultInstanceForType() {
        return RibEntryMessage.getDefaultInstance();
      }

      public RibEntryMessage build() {
        RibEntryMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public RibEntryMessage buildPartial() {
        RibEntryMessage result = new RibEntryMessage(this);
        int from_bitField0_ = bitField0_;
        if (ribEntryBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
            ribEntry_ = java.util.Collections.unmodifiableList(ribEntry_);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RibEntryMessage) {
          return mergeFrom((RibEntryMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(RibEntryMessage other) {
        if (other == RibEntryMessage.getDefaultInstance()) return this;
        if (ribEntryBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RibEntryMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RibEntryMessage) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensureRibEntryIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          ribEntry_ = new java.util.ArrayList<RibEntry>(ribEntry_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          RibEntry, RibEntry.Builder, RibEntryOrBuilder> ribEntryBuilder_;
       ...
       */
      public Builder setRibEntry(
          int index, RibEntry.Builder builderForValue) {
        if (ribEntryBuilder_ == null) {
          ensureRibEntryIsMutable();
       ...
       * </pre>
       */
      public Builder addRibEntry(RibEntry value) {
        if (ribEntryBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRibEntry(
          RibEntry.Builder builderForValue) {
        if (ribEntryBuilder_ == null) {
          ensureRibEntryIsMutable();
      ...
      public Builder addAllRibEntry(
          Iterable<? extends RibEntry> values) {
        if (ribEntryBuilder_ == null) {
          ensureRibEntryIsMutable();
       ...
       * </pre>
       */
      public RibEntry.Builder getRibEntryBuilder(
          int index) {
       ...
       * </pre>
       */
      public RibEntry.Builder addRibEntryBuilder() {
        return getRibEntryFieldBuilder().addBuilder(
            RibEntry.getDefaultInstance());
      }
      /**
       * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
       *
      ...
      public RibEntry.Builder addRibEntryBuilder(
          int index) {
        return getRibEntryFieldBuilder().addBuilder(
            index, RibEntry.getDefaultInstance());
      }
      /**
       * <code>repeated .net.named_data.jndn.tests.RibEntryMessage.RibEntry rib_entry = 128;</code>
       *
       ...
       * </pre>
       */
      public java.util.List<RibEntry.Builder>
           getRibEntryBuilderList() {
        return getRibEntryFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          RibEntry, RibEntry.Builder, RibEntryOrBuilder>
          getRibEntryFieldBuilder() {
        if (ribEntryBuilder_ == null) {
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_net_named_data_jndn_tests_RibEntryMessage_Route_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_net_named_data_jndn_tests_RibEntryMessage_Route_descriptor,
              new String[] { "FaceId", "Origin", "Cost", "Flags", "ExpirationPeriod", });
          internal_static_net_named_data_jndn_tests_RibEntryMessage_RibEntry_descriptor =
