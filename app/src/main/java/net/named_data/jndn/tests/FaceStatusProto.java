...
public final class FaceStatusProto {
  ...
  public interface FaceStatusMessageOrBuilder extends
     ...
     * </pre>
     */
    java.util.List<FaceStatusMessage.FaceStatus>
        getFaceStatusList();
    /**
     * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
     *
     ...
     * </pre>
     */
    FaceStatusMessage.FaceStatus getFaceStatus(int index);
    /**
     * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    java.util.List<? extends FaceStatusMessage.FaceStatusOrBuilder>
     ...
     * </pre>
     */
    FaceStatusMessage.FaceStatusOrBuilder getFaceStatusOrBuilder(
            int index);
  }
  /**
  ...
  public static final class FaceStatusMessage extends
          ...
          switch (tag) {
            ...
            case 1026: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                faceStatus_ = new java.util.ArrayList<FaceStatus>();
                mutable_bitField0_ |= 0x00000001;
              }
              faceStatus_.add(input.readMessage(FaceStatus.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FaceStatusProto.internal_static_net_named_data_jndn_tests_FaceStatusMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FaceStatusProto.internal_static_net_named_data_jndn_tests_FaceStatusMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FaceStatusMessage.class, Builder.class);
    }
    ...
    public static final class FaceStatus extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return FaceStatusProto.internal_static_net_named_data_jndn_tests_FaceStatusMessage_FaceStatus_descriptor;
      }

      protected FieldAccessorTable
          internalGetFieldAccessorTable() {
        return FaceStatusProto.internal_static_net_named_data_jndn_tests_FaceStatusMessage_FaceStatus_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                FaceStatus.class, Builder.class);
      }
      ...
      public static FaceStatus parseFrom(
      ...
      public static FaceStatus parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static FaceStatus parseFrom(
      ...
      public static FaceStatus parseFrom(java.io.InputStream input)
          throws java.io.IOException {
      ...
      public static FaceStatus parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static FaceStatus parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
      ...
      public static Builder newBuilder(FaceStatus prototype) {
      ...
      public static final class Builder extends
        ...
        public FaceStatus getDefaultInstanceForType() {
          return FaceStatus.getDefaultInstance();
        }

        public FaceStatus build() {
          FaceStatus result = buildPartial();
        ...
        public FaceStatus buildPartial() {
          FaceStatus result = new FaceStatus(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof FaceStatus) {
            return mergeFrom((FaceStatus)other);
          } else {
        ...
        public Builder mergeFrom(FaceStatus other) {
          if (other == FaceStatus.getDefaultInstance()) return this;
          if (other.hasFaceId()) {
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          FaceStatus parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (FaceStatus) e.getUnfinishedMessage();
            throw e;
          } finally {
  ...
  bitField0_ |= 0x00000004;
    ...
    private java.util.List<FaceStatus> faceStatus_;
    /**
     * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public java.util.List<FaceStatus> getFaceStatusList() {
      return faceStatus_;
    }
    /**
     * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
     ...
     * </pre>
     */
    public java.util.List<? extends FaceStatusOrBuilder>
        getFaceStatusOrBuilderList() {
      return faceStatus_;
    }
    /**
     ...
     * </pre>
     */
    public FaceStatus getFaceStatus(int index) {
     ...
     * </pre>
     */
    public FaceStatusOrBuilder getFaceStatusOrBuilder(
        int index) {
      return faceStatus_.get(index);
    }
    ...
    public static FaceStatusMessage parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static FaceStatusMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FaceStatusMessage parseFrom(
    ...
    public static FaceStatusMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static FaceStatusMessage parseFrom(
    ...
    public static FaceStatusMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static FaceStatusMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(FaceStatusMessage prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public FaceStatusMessage getDefaultInstanceForType() {
        return FaceStatusMessage.getDefaultInstance();
      }

      public FaceStatusMessage build() {
        FaceStatusMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public FaceStatusMessage buildPartial() {
        FaceStatusMessage result = new FaceStatusMessage(this);
        int from_bitField0_ = bitField0_;
        if (faceStatusBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
            faceStatus_ = java.util.Collections.unmodifiableList(faceStatus_);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FaceStatusMessage) {
          return mergeFrom((FaceStatusMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(FaceStatusMessage other) {
        if (other == FaceStatusMessage.getDefaultInstance()) return this;
        if (faceStatusBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FaceStatusMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FaceStatusMessage) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensureFaceStatusIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          faceStatus_ = new java.util.ArrayList<FaceStatus>(faceStatus_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          FaceStatus, FaceStatus.Builder, FaceStatusOrBuilder> faceStatusBuilder_;
       ...
       */
      public Builder setFaceStatus(
          int index, FaceStatus.Builder builderForValue) {
        if (faceStatusBuilder_ == null) {
          ensureFaceStatusIsMutable();
       ...
       * </pre>
       */
      public Builder addFaceStatus(FaceStatus value) {
        if (faceStatusBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFaceStatus(
          FaceStatus.Builder builderForValue) {
        if (faceStatusBuilder_ == null) {
          ensureFaceStatusIsMutable();
      ...
      public Builder addAllFaceStatus(
          Iterable<? extends FaceStatus> values) {
        if (faceStatusBuilder_ == null) {
          ensureFaceStatusIsMutable();
       ...
       * </pre>
       */
      public FaceStatus.Builder getFaceStatusBuilder(
          int index) {
       ...
       * </pre>
       */
      public FaceStatus.Builder addFaceStatusBuilder() {
        return getFaceStatusFieldBuilder().addBuilder(
            FaceStatus.getDefaultInstance());
      }
      /**
       * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
       *
      ...
      public FaceStatus.Builder addFaceStatusBuilder(
          int index) {
        return getFaceStatusFieldBuilder().addBuilder(
            index, FaceStatus.getDefaultInstance());
      }
      /**
       * <code>repeated .net.named_data.jndn.tests.FaceStatusMessage.FaceStatus face_status = 128;</code>
       *
       ...
       * </pre>
       */
      public java.util.List<FaceStatus.Builder>
           getFaceStatusBuilderList() {
        return getFaceStatusFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          FaceStatus, FaceStatus.Builder, FaceStatusOrBuilder>
          getFaceStatusFieldBuilder() {
        if (faceStatusBuilder_ == null) {
  ...
  static {
    ...
    internal_static_net_named_data_jndn_tests_FaceStatusMessage_FaceStatus_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_net_named_data_jndn_tests_FaceStatusMessage_FaceStatus_descriptor,
        new String[] { "FaceId", "Uri", "LocalUri", "ExpirationPeriod", "FaceScope", "FacePersistency", "LinkType", "NInInterests", "NInDatas", "NInNacks", "NOutInterests", "NOutDatas", "NOutNacks", "NInBytes", "NOutBytes", });
  }
